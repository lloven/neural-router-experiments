...
|---|---|---|---|---|
| vgpudesktop9 | nrouter-vm1 | RTX 2080 Ti (11GB) | /var/nvme-cache (239GB) | BLOCKED — crashes on ANY Python execution |
| vgpudesktop10 | nrouter-vm2 | RTX 2080 Ti (11GB) | /var/nvme-cache (371GB) | UNREACHABLE (2026-04-07) |

## Known issue (updated 2026-04-09)

**Likely root cause: container disk full** (Jani, 2026-04-09): "On GPU-Desktop6, your container had run out of disk space and may have been the cause of the strange hangs."
...
1. Ask Jani which VMs are now clean (disk-wise)
